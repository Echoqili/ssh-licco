...
from .interface import ClientType, SSHClientInterface
...
class SSHClientFactory:
    ...
    def create(
        ...
        return client_class(config)  # type: ignore[no-any-return,call-arg]
...
# 全局配置实例
_default_client_config: ClientConfig | None = None
