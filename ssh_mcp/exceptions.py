...
class ClientNotAvailableException(SSHException):
    ...
    def __init__(
        self, client_type: str, message: str = "", original_error: Exception | None = None
    ):
...
class PoolExhaustedException(SSHException):
    ...
    def __init__(
        self, message: str = "Connection pool is exhausted", original_error: Exception | None = None
    ):
        super().__init__(message, original_error)
...
class RetryExhaustedException(SSHException):
    ...
    def __init__(self, message: str, attempts: int = 0, original_error: Exception | None = None):
