...
from .clients.interface import ClientType, SSHClientInterface
...
class ConnectionPool:
    ...
    def __init__(
        ...
        self._validation_task: threading.Thread | None = None
    ...
    def acquire(self, timeout: int | None = None) -> PooledConnection:
        ...
        while True:
            try:
                pooled: PooledConnection = self._available.get(timeout=1)
...
class PooledSSHClient:
    ...
    def __init__(self, pool: ConnectionPool):
        self._pool = pool
        self._pooled_connection: PooledConnection | None = None
        self._closed = False
